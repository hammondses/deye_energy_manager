...
async def async_get_config_entry_diagnostics(hass: HomeAssistant, entry: ConfigEntry) -> dict[str, Any]:
    ...
    return {
        ...
        "inverter_cooling": {
            ...
            "temperature_trend_c_per_min": decision.cooling_temperature_trend_c_per_min if decision else None,
            "temperature_sample_at": decision.cooling_temperature_sample_at.isoformat() if decision and decision.cooling_temperature_sample_at else None,
            "load_change_w": decision.cooling_load_change_w if decision else None,
