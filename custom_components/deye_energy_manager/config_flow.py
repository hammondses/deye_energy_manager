...
def _thermal_schema(defaults: dict[str, Any]) -> vol.Schema:
    thermal_keys = [
        ...
        "thermal_export_start_w",
        "thermal_export_keep_w",
        "thermal_export_import_tolerance_w",
        ...
        "overnight_dining_min_room_temp",
        "overnight_dining_target_temp",
        "overnight_dining_soc_margin",
    ...
    return vol.Schema(
        {
            ...
            **{
                ...
                for key, minimum, maximum, step in (
                    ("cooling_update_interval_s", 1, 60, 1),
                    ("cooling_trend_window_s", 30, 300, 5),
                    ("cooling_trend_min_observation_s", 5, 30, 5),
                    ("cooling_temperature_stale_s", 15, 600, 5),
                    ("cooling_recovery_trigger_temp_c", 40, 75, 0.1),
                    ("cooling_recovery_release_temp_c", 30, 60, 0.1),
                    ("cooling_target_temp_c", 35, 55, 0.1),
