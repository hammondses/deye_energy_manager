...
SENSORS: tuple[DeyeSensorDescription, ...] = (
    ...
    DeyeSensorDescription(key="bedroom_night_heating_reason", name="Bedroom night heating reason", value_fn=lambda d: d.bedroom_night_heating_reason),
    DeyeSensorDescription(key="overnight_dining_comfort_reason", name="Overnight dining comfort reason", value_fn=lambda d: d.overnight_dining_comfort_reason),
    DeyeSensorDescription(key="overnight_dining_load_to_add", name="Overnight dining load to add", value_fn=lambda d: d.overnight_dining_load_to_add),
    DeyeSensorDescription(key="projected_soc_07_with_overnight_dining", name="Projected SOC 07:00 with overnight dining", native_unit_of_measurement=PERCENTAGE, state_class=SensorStateClass.MEASUREMENT, value_fn=lambda d: d.projected_soc_07_with_overnight_dining),
