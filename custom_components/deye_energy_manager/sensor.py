...
SENSORS: tuple[DeyeSensorDescription, ...] = (
    ...
    DeyeSensorDescription(key="remaining_solar_budget_kwh", name="Remaining solar budget", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, value_fn=lambda d: d.remaining_solar_budget_kwh),
    DeyeSensorDescription(key="battery_kwh_needed_to_target", name="Battery kWh needed to target", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, value_fn=lambda d: d.battery_kwh_needed_to_target),
    DeyeSensorDescription(key="expected_house_load_until_solar_end", name="Expected house load until solar end", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, value_fn=lambda d: d.expected_house_load_until_solar_end_kwh),
    DeyeSensorDescription(key="discretionary_energy_budget", name="Discretionary energy budget", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT, value_fn=lambda d: d.discretionary_energy_budget_kwh),
