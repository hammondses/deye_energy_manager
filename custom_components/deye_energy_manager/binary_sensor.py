...
BINARY_SENSORS = (
    ...
    DeyeBinarySensorDescription(key="solar_soak_allowed", name="Curtailment soak allowed", value_fn=lambda d: d.solar_soak_allowed),
    DeyeBinarySensorDescription(key="export_soak_available", name="Curtailment signal available", value_fn=lambda d: d.export_soak_available),
    ...
    DeyeBinarySensorDescription(key="overnight_dining_comfort_allowed", name="Overnight dining comfort allowed", value_fn=lambda d: d.overnight_dining_comfort_allowed),
    ...
    DeyeBinarySensorDescription(key="pv_load_test_recommended", name="Curtailment soak recommended", value_fn=lambda d: d.pv_load_test_recommended),
