...
NUMBERS = (
    ...
    DeyeNumberDescription(key="cooling_hunt_step_interval_min", name="Cooling hunt observation minutes", native_unit_of_measurement="min", native_min_value=1, native_max_value=60, native_step=1, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["cooling_hunt_step_interval_min"]),
