...
NUMBERS = (
    ...
    DeyeNumberDescription(key="cooling_target_temp_c", name="Cooling target temperature", native_unit_of_measurement=UnitOfTemperature.CELSIUS, native_min_value=35, native_max_value=55, native_step=0.5, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["cooling_target_temp_c"]),
    ...
    DeyeNumberDescription(key="cooling_target_deadband_c", name="Cooling target deadband", native_unit_of_measurement=UnitOfTemperature.CELSIUS, native_min_value=0, native_max_value=5, native_step=0.5, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["cooling_target_deadband_c"]),
    ...
    DeyeNumberDescription(key="cooling_fan_failure_temp_c", name="Cooling fan failure trip temperature", native_unit_of_measurement=UnitOfTemperature.CELSIUS, native_min_value=45, native_max_value=65, native_step=0.5, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["cooling_fan_failure_temp_c"]),
