...
NUMBERS = (
    ...
    DeyeNumberDescription(key="thermal_export_start_w", name="Thermal export start", native_unit_of_measurement=UnitOfPower.WATT, native_min_value=0, native_step=100, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["thermal_export_start_w"]),
    DeyeNumberDescription(key="thermal_export_keep_w", name="Thermal export keep", native_unit_of_measurement=UnitOfPower.WATT, native_min_value=0, native_step=100, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["thermal_export_keep_w"]),
    DeyeNumberDescription(key="thermal_export_import_tolerance_w", name="Thermal export import tolerance", native_unit_of_measurement=UnitOfPower.WATT, native_min_value=0, native_step=100, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["thermal_export_import_tolerance_w"]),
