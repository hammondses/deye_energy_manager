...
NUMBERS = (
    ...
    DeyeNumberDescription(key="cooling_feedback_step_pct", name="Cooling feedback step", native_unit_of_measurement=PERCENTAGE, native_min_value=1, native_max_value=20, native_step=1, mode=NumberMode.BOX, default=NUMBER_DEFAULTS["cooling_feedback_step_pct"]),
